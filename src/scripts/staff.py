    ...
    def getPitch(self, note_center_y):
        ...
        if note_center_y in self.line_one:
            ...
            if note_center_y < self.line_one[0]:
                ...
                current_line = [
                    pixel - self.line_spacing for pixel in self.line_one
                ...
                while current_line[0] > 0:
                    if note_center_y in current_line:
                        ...
                        current_line = [
                            pixel - self.line_spacing for pixel in current_line
                        ]
                ...
                current_line = [
                    pixel + self.line_spacing for pixel in self.line_five
                ]  # Go to next line above
